...
public class myQueue extends AppCompatActivity
    ...
    private View mQueueOrderFormView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQueueOrderFormView = findViewById(R.id.queueOrder_form);
        mProgressView = findViewById(R.id.queueOrder_progress);

        lv_order = (ListView)findViewById(R.id.lv_order);

        showProgress(true);
        orderTask = new orderAsyncTask(userInfo.apiURL+"/getQueueOrder.action?name="+userInfo.getEmail().toString());
        ...
        lv_order.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(myQueue.this, myOrderDetail.class);
    ...
    private void showProgress(final boolean show) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
            ...
            mQueueOrderFormView.setVisibility(show ? View.GONE : View.VISIBLE);
            mQueueOrderFormView.animate().setDuration(shortAnimTime).alpha(
...
//            orderAdapter = new SimpleAdapter(myQueue.this,list_order,R.layout.order_item,
...
//                    new int[]{R.id.srcStation,R.id.desStation,R.id.srcDate,R.id.trainNum,R.id.orderType});
            ...
            if(list_order.size()==0){
                TextView noneData = new TextView(myQueue.this);
                noneData.setText("无相关数据");
                ((RelativeLayout)findViewById(R.id.rl_queueOrder)).addView(noneData);
            }else{
                queueSimpleAdapter orderAdapter = new queueSimpleAdapter(myQueue.this,list_order,R.layout.order_item);
    ...
    class queueSimpleAdapter extends SimpleAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup group) {
            ...
            int str_orderType =  Integer.parseInt(mData.get(position).get("maxQueueNum").toString())-Integer.parseInt(mData.get(position).get("queneNum").toString())+1;
            ((TextView) view.findViewById(R.id.orderType)).setText("第"+str_orderType+"位");
