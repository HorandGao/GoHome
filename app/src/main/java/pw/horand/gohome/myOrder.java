...
public class myOrder extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAllOrderFormView = findViewById(R.id.allOrder_form);
        mProgressView = findViewById(R.id.allOrder_progress);
        ...
        showProgress(true);
        orderTask = new orderAsyncTask(userInfo.apiURL+"/getOrder.action?name="+userInfo.getEmail().toString());
...
//                    new int[]{R.id.srcStation,R.id.desStation,R.id.srcDate,R.id.trainNum,R.id.orderType});
            ...
            if(list_order.size()==0){
                TextView noneData = new TextView(myOrder.this);
                noneData.setText("无相关数据");
                ((RelativeLayout)findViewById(R.id.rl_allOrder)).addView(noneData);
            }else{
                queueSimpleAdapter orderAdapter = new queueSimpleAdapter(myOrder.this,list_order,R.layout.order_item);
